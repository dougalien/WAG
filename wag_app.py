        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "   - Then give a clear, simple report.\n"
...
st.markdown(
    '<div class="wag-subtitle">A dog-walking helper by We Are Dougalien — powered by Perplexity Sonar.</div>',
    unsafe_allow_html=True,
)
st.markdown('<div class="wag-separator">🐾 🦴 🐾</div>', unsafe_allow_html=True)
st.markdown(
    '<p class="wag-body-text">'
    "Press the button below to get today&apos;s tide, weather, and walk plan for Steve."
    "</p>",
    unsafe_allow_html=True,
)
